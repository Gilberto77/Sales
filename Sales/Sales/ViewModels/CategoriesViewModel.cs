namespace Sales.ViewModels
{
    ...
    public class CategoriesViewModel : BaseViewModel
    {
                ...
                
        {
            ...
            var response = await this.apiService.GetList<Category>(url, prefix, controller,
            Settings.TokenType, Settings.AccessToken);
        ...
        private void RefreshList()
        {
            ...
            {
                var myListCategoriesItemViewModel = this.MyCategories.Select(c => new
